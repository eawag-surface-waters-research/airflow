...
dag = DAG(
    'simulate_delft3dflow_operational_geneva',
    default_args=default_args,
    description='Operational Delft3D-Flow simulation of Lake Geneva.',
    schedule_interval="0 9 * * *",
    catchup=False,
    tags=['simulation'],
    user_defined_macros={'model': 'delft3d-flow/geneva',
...
notify_api = PythonOperator(
    ...
    params={"file": "https://alplakes-eawag.s3.eu-central-1.amazonaws.com/simulations/delft3d-flow/results/eawag_delft3dflow6030062434_delft3dflow_geneva",
            "api": "http://eaw-alplakes2:8000"},
